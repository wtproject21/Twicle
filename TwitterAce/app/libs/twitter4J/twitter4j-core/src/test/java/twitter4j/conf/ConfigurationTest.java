...
public class ConfigurationTest {
    ...
    void testConfiguration() throws Exception {
        ...
        writeFile("libs/twitter4j.properties", "twitter4j.http.readTimeout=1234");
        conf = new PropertyConfiguration();
        assertEquals(1234, conf.getHttpClientConfiguration().getHttpReadTimeout());
        writeFile("libs/twitter4j.properties", "twitter4j.http.readTimeout=4321");
        conf = new PropertyConfiguration();
    ...
    void testSSL() throws Exception {
        ...
        // disable SSL
        writeFile("libs/twitter4j.properties", "twitter4j.restBaseURL=http://somewhere.com/"
        ...
        writeFile("libs/twitter4j.properties", "restBaseURL=http://somewhere.com/");
        conf = new PropertyConfiguration("/");
        assertEquals("http://somewhere.com/", conf.getRestBaseURL());
        deleteFile("libs/twitter4j.properties");
    }
    ...
    void testTwitter4jPrefixOmittable() throws Exception {
        ...
        conf = new PropertyConfiguration("/");
        assertEquals("http://somewhere.com/", conf.getRestBaseURL());
        writeFile("libs/twitter4j.properties", "restBaseURL=http://somewhere2.com/");
